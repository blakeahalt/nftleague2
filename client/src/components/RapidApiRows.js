    ...
    return (
        <div>
            	<Row style={{ maxHeight: '75px', fontSize: 25, flexWrap: 'nowrap', marginBottom:10 }} >
                  ...
                  <Col style={{ minWidth: 455, maxWidth: 530, marginLeft:-95, marginTop:25 }}> Collection </Col>
                  <Col style={{ minWidth: 102, maxWidth: 200, marginLeft:125, marginTop:25, textAlign:'right' }}> Trades </Col>
                  <Col style={{ minWidth: 102, maxWidth: 400, marginTop:25, textAlign:'right' }}> Volume </Col>
                  <Col style={{ minWidth: 102, maxWidth: 400, marginTop:25, textAlign:'right' }}> Floor </Col> 
                  <Col style={{ minWidth: 102, maxWidth: 400, textAlign:'right' }}> Avg. Price </Col> 
                  <Col style={{ minWidth: 160, maxWidth: 400, marginRight:10, flexWrap: 'wrap', textAlign:'right' }}> Owners / Supply </Col> 
                  {/* <Col style={{ minWidth: 160, maxWidth: 400, textAlign:'right', marginRight:10, flexWrap: 'nowrap' }}> Market Cap </Col>  */}
                </Row>

            {both.map((row, id) => {
              return(
                <Row className="row-stripe" style={{ height: '100px', paddingBottom:0, flexDirection:'row' }} key={id}>
                  <Col style={{ maxWidth:50, marginTop:35, marginLeft:5, textAlign:'right', fontSize:22 }}> {row.index} </Col>
                  <Col style={{ minHeight:75, maxWidth:100, paddingLeft:15 }}> 
                      <img src={row.image_url} style={{height:80, maxWidth:75, verticalAlign:-75 }} alt="pfp"></img> </Col>
                  <Col style={{ minWidth: 450, maxWidth: 500, marginTop:8, fontSize:22 }}>{row.name}
                      <br/>
