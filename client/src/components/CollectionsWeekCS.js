...
function UserList() {
  ...
  useEffect(() => {
    fetch('https://api.cryptoslam.io/im6pi8nxcs120nhb/v1/collections/top-100?timeRange=week', CSoptions)
  ...
  return (
    <>
        ...
        <div className="container">
            <h2 style={{ textAlign: 'center', fontSize: 42, marginTop: 20, marginBottom: 30 }}> CRYPTO SLAM: Top of the Week 
