            ...
            <h2 style={{ textAlign: 'center', fontSize: 42, marginTop: 0, marginBottom: 10 }}> Top Collections </h2>
                <div style={{ position: 'relative', textAlign: 'center', marginTop: -10, marginBottom: 20}}>
                  <Link to='/CollectionsDay' style={{color:'black'}}>
                    <button className="button-days"> 1DAY </button></Link>
                  <Link to='/CollectionsWeek' style={{color:'black'}}>
                    <button className="button-days" style={{ backgroundColor:'gray', color:'darkgray' }}> 7DAY </button></Link>
              ...
              <Row style={{ height: '75px', fontSize: 25, flexWrap: 'nowrap', marginTop: 20, marginBottom:-20 }} >
                <Col style={{ minWidth: 250, maxWidth: 500, marginLeft: 20 }}> Collection </Col>
                <Col style={{ minWidth: 180, maxWidth: 400, paddingLeft:100 }}> Trades </Col>
                <Col style={{ maxWidth: 200, marginRight:20 }}> Volume </Col>
              </Row>
