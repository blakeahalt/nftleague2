  ...
  return (
    <> 
        ...
        <div className="container">
            <h2 style={{ textAlign: 'center', fontSize: 42, marginTop: 20, marginBottom: 30 }}> Top Daily <br/>
                <Link to='/RapidAPICollectionsDay' style={{color:'black'}}>
                    <button className="button-days" style={{marginLeft:20, marginBottom:0, padding:5, color:'darkgray', backgroundColor:'gray'}}> 1DAY </button></Link>
