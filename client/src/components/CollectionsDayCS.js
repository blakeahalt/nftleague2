...
function UserList() {
  ...
  useEffect(() => {
    fetch('https://api.cryptoslam.io/im6pi8nxcs120nhb/v1/collections/top-100?timeRange=day', CSoptions)
  ...
  return (
    <>
        ...
        <div className="container">
            <h2 style={{ textAlign: 'center', fontSize: 42, marginTop: 20, marginBottom: 30 }}> CRYPTO SLAM: Top of the Day 
                {/* <div style={{ position: 'relative', marginTop: -10, marginBottom: 20}}> */}
                <Link to='//CryptoslamDay' style={{color:'black'}}>
                    <button className="button-days" style={{marginLeft:20, marginBottom:0, padding:5, backgroundColor:'gray', color:'darkgray'}}> 1DAY </button></Link>
