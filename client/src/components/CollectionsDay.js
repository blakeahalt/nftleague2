...
function UserList() {
    ...
    const both = collectionData.map((item, i) =>
        Object.assign({}, item, rowDataSales1[i])
    );
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <Col
                        style={{ minWidth: 50, maxWidth: 200, marginLeft: 120 }}
                    >
                        {' '}
                        Trades{' '}
                    </Col>
                    <Col style={{ maxWidth: 200 }}> Volume </Col>
                    <Col style={{ maxWidth: 200, marginRight: 10 }}>
                        {' '}
                        Floor{' '}
                    </Col>
                </Row>
