  ...
  return (
    <> 
        ...
        <div className="container">
            <h2 style={{ textAlign: 'center', fontSize: 42, marginTop: 20, marginBottom: 30 }}> Top of the Week <br/>
                ...
                <Link to='/RapidAPICollectionsWeek' style={{color:'black' }}>
                    <button className="button-days" style={{color:'darkgray', backgroundColor:'gray' }}> 7DAY </button></Link>
